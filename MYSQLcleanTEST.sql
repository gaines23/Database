...
IF DB_ID('CleanCompanyTest2') IS NOT NULL

	DROP DATABASE CleanCompanyTest2



CREATE DATABASE CleanCompanyTest2

GO



USE CleanCompanyTest2
...
CREATE TABLE Employee( 
	...
	, GarmLength VARCHAR(3)

	, EmpAddress VARCHAR(55) NOT NULL
	...
	, AlterationInstructions VARCHAR(100)
...
CREATE TABLE Manufacturer(
	...
	, ManuAddress VARCHAR(55)

	, ManuPhone VARCHAR(12)

	, ManuEmail VARCHAR(55)
...
CREATE TABLE CleanerInfo(
	...
	CleanerID INT AUTO_INCREMENT PRIMARY KEY NOT NULL

	, CleanerName INT NOT NULL

	, CleanerAddress VARCHAR(100)

	, CleanerPhone VARCHAR (15) NULL

	, CleanerEmail VARCHAR(55)
...
CREATE TABLE Hierarchy( 
	...
	JobHierarchyID INT AUTO_INCREMENT NOT NULL PRIMARY KEY
...
CREATE TABLE GarmDefaultValues(
	...
	GarmDefaultID INT AUTO_INCREMENT NOT NULL PRIMARY KEY
...
CREATE TABLE GarmDepreciation(
	...
	GarmDeprecID INT AUTO_INCREMENT NOT NULL PRIMARY KEY
...
CREATE TABLE GarmActivity(
	...
	GarmActivityID INT AUTO_INCREMENT NOT NULL PRIMARY KEY
...
CREATE TABLE MissingGarments(
	...
	MissingGarmID INT AUTO_INCREMENT NOT NULL PRIMARY KEY
...
CREATE TABLE DeletedGarments(
	...
	DeletedGarmsID INT AUTO_INCREMENT NOT NULL PRIMARY KEY
...
CREATE TABLE Accounting(
	...
	AccountingID INT AUTO_INCREMENT NOT NULL PRIMARY KEY
...
CREATE TABLE ReturnedSales(
	...
	ReturnedID INT AUTO_INCREMENT NOT NULL PRIMARY KEY 
...
CREATE TABLE PurchaseOrder(
	...
	PurchaseOrderID INT AUTO_INCREMENT NOT NULL PRIMARY KEY
...
CREATE TABLE EmpOrder(
	...
	EmpOrderID INT AUTO_INCREMENT PRIMARY KEY NOT NULL
...
CREATE TABLE CleaningActivity(
	...
	CleaningActID INT AUTO_INCREMENT NOT NULL PRIMARY KEY
...
CREATE TABLE Repairs(
	...
	RepairID INT AUTO_INCREMENT NOT NULL PRIMARY KEY
...
CREATE TABLE DeviceOptions(
	...
	DeviceOptionID INT AUTO_INCREMENT NOT NULL PRIMARY KEY

	, SigPad VARCHAR(100)

	, LabelPrinter VARCHAR(50)

	, TouchScreen VARCHAR(100)

	, BulkScanner VARCHAR(100)
...
FROM EmpJobGarm AS em JOIN Employee AS e ON em.EmpID = e.EmpID

JOIN GarmActivity AS ga ON ga.EmpID = em.EmpID

JOIN NonTaggedGarm AS nt ON nt.GarmentID = em.GarmentID

JOIN MissingGarments AS mi ON mi.GarmentID = em.GarmentID





-- This will become a procedure to continuously pull data

INSERT INTO 

	Inventory(em.GarmentID, e.EmpID, ga.Conveyor, nt.NonTaggedGarmID, mi.MissingGarmID,mi.MissingDateTime)

	SELECT em.GarmentID, ga.SlotNum, ga.Conveyor, nt.NonTaggedGarmID, mi.MissingGarmID, mi.MissingDateTime

		FROM Employee AS e

			JOIN EmpJobGarm AS em ON e.EmpID = em.EmpID
