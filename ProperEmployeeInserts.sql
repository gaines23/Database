...
INSERT INTO Employee (EmpID, FirstName, LastName, Address, PhoneNmber, Email)
	VALUES (100003, 'Mike', 'Ortega', '2323 Channel Rd.', '619-999-2423', 'ortega@yahoo.com'),
		(100004, 'Bailey', 'Voss', '1234 Love Ln.', '999-323-5454', 'bvoss@gmail.com'),
        (100005, 'Jeff', 'Dale', '43333 Old Man Ln.', '323-854-1234', 'jeffrey@cox.net');

INSERT INTO Employee (EmpID, FirstName, LastName, Address, PhoneNmber, Email)
	VALUES (100006, 'Dale', 'Benson', '123 Somewhere Ville', '878-654-9876', 'dbenson@ymail.com'),
		(100007, 'Louise', 'Voss', '123 Somewhere Ville', '122-123-4567', 'lvoss.24@ymail.com'),
        (100008, 'Scott', 'Benson', '4333 Old Man ln.', '111-234-5432', 'sbsb@ymail.com'),
        (100009, 'Karen', 'Warner', '9876 IdontKnow', '232-456-7890', 'meanpeoplexist@ymail.com'),
		(100004, 'Bailey', 'Voss', '1234 Love Ln.', '999-323-5454', 'bvoss@gmail.com'),
        (100005, 'Jeff', 'Dale', '43333 Old Man Ln.', '323-854-1234', 'jeffrey@cox.net');
...
INSERT INTO Employee (EmpID, FirstName, LastName, Address, PhoneNmber, Email)
	VALUES (100010, 'Joe', 'Shmoo','3535 Josph Ln.', '123-454-7677', 'joeshmoo@yahoo.com'),
        ...
        (100013, 'Rachel', 'Benson', '1234 Cat ln.', '800-123-1234', 'afifan@gmail.com');
